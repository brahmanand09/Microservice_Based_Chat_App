                                ...
                                isEdit ? (<form onSubmit={submitHandler} className='space-y-4'>
                                    <div className="relative">
                                        <input type="text" value={name} onChange={e => setName
                                            (e.target.value)} className='w-full px-4 py-3 bg-gray-700 border border-gray-600 rounded-lg
                                    ...
                                    <div className='flex items-center justify-between p-4 bg-gray-700 rounded-lg boder border-gray-600'>
                                        <span className="text-white font-medium text-lg">
                                            {user?.name || "Not set"}
                                        </span>
                                        <button onClick={editHandler}
                                            className='flex items-center gap-2 px-6 py-3 bg-gray-600 hover:bg-gray-700
                                        text-white font-semibold rounded-lg'>Edit</button>
                                    </div>
                                )}
                        </div>
                    </div>
