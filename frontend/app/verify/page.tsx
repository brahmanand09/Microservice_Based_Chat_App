            ...
            <div className="max-w-md w-full">
                <div className="bg-gray-800 border border-gray-700 rounded-lg p-8">
                    <div className="text-center mb-8 relative">
                        ...
                        <h1 className="text-4xl font-blod text-white mb-3">
                            Verify Your Email
                        </h1>
                        <p className='text-gray-300 text-lg'>We have sent a 6 digits code to</p>
                        <p className="text-blue-600 font-medium">{email}</p>
                    </div>
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div>
                            <label className='block text-sm font-medium text-gray-300 mb-4 text-center'>Email your 6 digits OTP here</label>
                    ...
                    <div className="mt-6 text-center">
                        ...
                        {timer > 0 ? (
                            ...
                            <button className="text-blue-400 hover:text-blue-300 font-medium text-sm disabled:opacity-50" disabled={resendLoding}
                                onClick={handleResendOtp}>
                                {resendLoding ? "Sending...." : "Resend Code"}
                            </button>
                        )}
                    </div>
                </div>
